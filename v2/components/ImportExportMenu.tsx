        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 w-56 z-20 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-xl overflow-hidden"
            >
              {/* Import section */}
              <div className="px-3 pt-3 pb-1">
                <p className="text-xs font-display font-bold tracking-wider uppercase text-neutral-400 dark:text-neutral-500 px-1 mb-1">
                  Import
                </p>
                <button
                  onClick={() => {
